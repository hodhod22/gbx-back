...
if (!databaseUrl) {
    console.warn("⚠️ DATABASE_URL not set, falling back to local development config");
}
...
pool.connect((err, client, release) => {
    if (err) {
        ...
        if (err.message.includes("ENOTFOUND") ||
            ...
            console.error("💡 Hint: Check that your DATABASE_URL uses the correct hostname. For Render, use the internal URL (starting with postgresql://...render.com)");
        }
    }
    else {
